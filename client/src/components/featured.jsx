        ...
        <div>
            ...
            <div className="cards">
                <div className="card col-3">
                    <img className="card-img-top p-3" src={reactlogo} alt="Card image cap" />
                ...
                <div className="card col-3">
                    <img className="card-img-top p-3" src={fire} alt="Card image cap" />
                    <div className="card-body">
                ...
                <div className="card col-3">
                    <img className="p-3 card-img-top" src={coast} alt="Card image cap" />
                    <div className="card-body">
